...
//            if(message.getMessageType()== MessageType.IMG && message.getDrawableResId() == 0){
//                //show dialog.
//                CustomDialogManager.instance.imageDialog(context, (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE), message.getDrawableResId());
//            }
